...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.13", body: "Extensão v2.13.0 — máscara V15 write-once por nó (flag data-acto-masked). Mostra somente ⚡ 𝖠𝖢𝖳𝖮 𝖯𝗋𝗈𝗆𝗉𝗍 𝖱𝖾𝖼𝖾𝖻𝗂𝖽𝗈, sem prompt/anexo. Sem setInterval, sem re-escrita.", href: "/ACTO-tier-s-elite-v15.zip", cta: "Download v15" },
