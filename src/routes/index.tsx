...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.16", body: "Extensão v2.16.0 — chat local persistente por sessão. Overlay sobre o composer com bolhas WhatsApp-style à direita, timestamp HH:MM, status sending/sent/error. Botão Limpar zera só o histórico visual. chrome.storage.session, 300 msg max, scroll auto, prefers-reduced-motion respeitado.", href: "/ACTO-tier-s-elite-v18.zip", cta: "Download v18" },
