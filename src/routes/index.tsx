...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.9", body: "Extensão v2.9.0 — Plan Capture robusto: regex por substring (Approve plan/Reject), aria-label/title, WeakSet anti-rerender e __ACTO_RESCAN__ p/ debug. Injeta botão ao lado do Approve nativo.", href: "/ACTO-tier-s-elite-v9.zip", cta: "Download v9" },
