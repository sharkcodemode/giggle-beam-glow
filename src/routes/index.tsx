...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.10", body: "Extensão v2.10.0 — Plan Capture dual-mode: (A) cards Approve/Reject e (B) bolhas de MODO PLANO (## 1..## 11, PLANO TIER-S). Botão 📋 COPIAR PLANO injetado direto na bolha, 0 créditos.", href: "/ACTO-tier-s-elite-v10.zip", cta: "Download v10" },
