...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.14", body: "Extensão v2.14.0 — painel mantém o texto enviado visível após disparar o prompt. Máscara V15 write-once por nó na bolha nativa, sem prompt/anexo exposto.", href: "/ACTO-tier-s-elite-v16.zip", cta: "Download v16" },
