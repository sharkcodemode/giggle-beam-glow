...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.12", body: "Extensão v2.12.0 — máscara V14 com escopo por aba (sessionStorage + projectId). Corrige vazamento de prompt entre janelas/projetos abertos simultaneamente.", href: "/ACTO-tier-s-elite-v12.zip", cta: "Download v12" },
