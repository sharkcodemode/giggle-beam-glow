...
// ─── assets (preservados) ──────────────────────────────────────
const HERO_IMG = heroBannerAsset;
const EDITAL_PDF =
...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.20", body: "Extensão v2.20.0 — Fix Relay. O chat nativo da Lovable aceita a ação com HTTP 202 e responde via websocket interno; portanto não há SSE real nesse caminho. Streaming real fica disponível na rota direta `gateway_stream` para UI ACTO própria.", href: "/ACTO-tier-s-elite-v24.zip", cta: "Download v24" },
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="conic-border floaty relative aspect-[4/5] overflow-hidden rounded-[28px] bg-[var(--obsidian-2)]">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <p className="font-mono text-[10px] uppercase tracking-[0.35em] text-[var(--aurora-mint)]">Organic Synthesis</p>
                  <p className="mt-2 font-display text-3xl italic leading-tight">Qual ferramenta vc usou para gerar a imagem ?</p>
                </div>
              </div>
