...
const ASSETS: ReadonlyArray<Asset> = [
  ...
  { no: "08", kind: "tool",   title: "ACTO Elite Ext",            tag: "Chrome v2.15", body: "Extensão v2.15.0 — fluxo de chat correto: textarea limpa após envio, mensagem vai pro histórico como bolha do user, card '✅ Enviado' confirma o disparo. Histórico empilha enquanto o side panel está aberto.", href: "/ACTO-tier-s-elite-v17.zip", cta: "Download v17" },
